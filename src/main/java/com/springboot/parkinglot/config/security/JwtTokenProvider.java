...
public class JwtTokenProvider {
    ...
    private String secretKey = "flature!@#";    //temporary secretKey!
    ...
    public Authentication getAuthentication(String token){
        ...
        LoginUserDetails loginUserDetails = loginUserDetailService.loadUserByUsername(this.getUserName(token));
